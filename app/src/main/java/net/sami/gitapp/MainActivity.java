...
import net.sami.gitapp.model.GitUser;
import net.sami.gitapp.model.UsersListViewModel;
import net.sami.gitapp.service.GitRepoServiceAPI;
import net.sami.gitapp.R;
